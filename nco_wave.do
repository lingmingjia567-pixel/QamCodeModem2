...
add wave -noupdate -format Literal -radix unsigned /nco_tb/phi_ch0
add wave -noupdate -format Literal -radix unsigned /nco_tb/phi_ch1
...
add wave -noupdate -color Yellow -format Analog-Step -radix decimal -scale 2.5E-4 /nco_tb/sin_val_ch0

add wave -noupdate -divider -height 80 {cosine waveform}
add wave -noupdate -color Cyan -format Analog-Step -radix decimal -scale 2.5E-4 /nco_tb/cos_val_ch0

add wave -noupdate -divider -height 80 {sine waveform}
add wave -noupdate -color Yellow -format Analog-Step -radix decimal -scale 2.5E-4 /nco_tb/sin_val_ch1

add wave -noupdate -divider -height 80 {cosine waveform}
add wave -noupdate -color Cyan -format Analog-Step -radix decimal -scale 2.5E-4 /nco_tb/cos_val_ch1
