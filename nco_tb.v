...
wire [17:0] sin_val;
wire [17:0] cos_val;
reg [17:0] sin_val_ch0;
reg [17:0] cos_val_ch0;
reg [17:0] sin_val_ch1;
reg [17:0] cos_val_ch1;
reg [31:0] phi;
reg [31:0] phi_ch0;
reg [31:0] phi_ch1;
reg sel_phi;
...
initial
  begin
    ...
    #0 reset_n = 1'b0;
    #0 clken = 1'b1;
    #0 phi_ch0 = 32'b00000010100011110101110000101001;
    #0 phi_ch1 = 32'b00000001010001111010111000010100;
