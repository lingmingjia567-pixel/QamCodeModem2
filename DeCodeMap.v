...
module DeCodeMap (
	...
	output [3:0]	dout;    //解调后的原始数据
	 ...
	 wire c3xorc2, c3xord2, c3xord3;
            assign c3xorc2 = code[3] ^ code[2];        //code[3]为Ik，code[2]为Qk,Ik⊕Qk
            assign c3xord2 = code[3] ^ d2;            //Ik⊕Q(k-1)
            assign c3xord3 = code[3] ^ d3;            //Ik⊕I(k-1)
            assign c = ((!c3xorc2) & c3xord2) ^ (c3xorc2 & c3xord3);    //A k =[ !(I k ⊕Q k )⋅(I k ⊕Q k−1 )]⊕[(I k⊕Q k )⋅(I k ⊕I k−1 )]
            
            wire c2xord3, c2xord2;
            assign c2xord3 = code[2] ^ d3;            //Qk⊕I(k-1)
            assign c2xord2 = code[2] ^ d2;            //Qk⊕Q(k-1)
            assign d = ((!c3xorc2) & c2xord3) ^ (c3xorc2 & c2xord2);    //B k =[ !(I k ⊕Q k )⋅(Q k ⊕I k−1 )]⊕[(I k⊕Q k )⋅(Q k ⊕Q k−1 )]
